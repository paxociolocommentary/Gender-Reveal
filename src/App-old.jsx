...
const randomizedJokes = shuffleArray(JOKES);
...
const HYPE_MESSAGES = [
  ...
  { text: 'again', color: '#fcf6bd' },
  { text: 'do 3 jumping jacks if you really want a girl', color: '#ffafcc' },
  { text: 'do 3 push ups if you really want a boy', color: '#a2d2ff' },
...
function App() {
  ...
  useEffect(() => {
    ...
    const items = phase === PHASES.JOKES ? randomizedJokes : HYPE_MESSAGES
